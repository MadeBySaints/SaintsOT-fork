TargetBot.Creature.edit = function(config, callback) -- callback = function(newConfig)
  ...
  addScrollBar("attackSpellDelay", "Attack spell delay", 1, 5000, 10)
  ...
  addScrollBar("groupAttackDelay", "Group attack spell delay", 1, 60000, 10)
  addScrollBar("runeAttackDelay", "Rune attack delay", 1, 5000, 10)
  ...
  addScrollBar("groupRuneAttackDelay", "Group rune attack delay", 1, 60000, 10)
